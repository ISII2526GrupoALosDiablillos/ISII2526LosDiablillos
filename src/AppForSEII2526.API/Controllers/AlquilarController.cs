...
namespace AppForSEII2526.API.Controllers
{
    ...
    public class AlquilarController : ControllerBase
    {
        ...
        //     })
        //        .ToList();
        //    Alquilar alquilar = new Alquilar(alquilarForCreateDTO.NombreCliente, alquilarForCreateDTO.ApellidoCliente, User, alquilarForCreateDTO.DireccionEnvio, DateTime.Now, (AppForSEII2526.API.Models.PaymentMethodTypes)alquilarForCreateDTO.PaymentMethod, alquilarForCreateDTO.FechaInicio, alquilarForCreateDTO.FechaFin, new List<AlquilarItem>());
        ...
        //        var alquilerDetailDTO = new AlquilarDetailDTO(alquilar.Id, alquilar.FechaAlquiler, alquilar.applicationUser.nombreCliente, alquilar.applicationUser.apellidoCliente, alquilar.DireccionEnvio, (PaymentMethodTypes)alquilar.metodoPago, alquilar.FechaFin, alquilar.FechaInicio, AlquilarForCreateDTO.AlquilarItems);
